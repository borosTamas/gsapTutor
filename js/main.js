...
const tlBug2 = new TimelineMax({delay:1,onComplete:function () {this.restart()}});
...
document.querySelector(".helloDiv").addEventListener("click",function () {
    ...
    tml.fromTo(".bug2",0.5,{width:"0"},{width:"5%",visibility: "visible",ease: Elastic.easeOut.config(1.5, 0.2)});
    tlBug2.to(".bug2",4, {css: {bezier: [{left:'90%', top:'60%'}, {left:'60%', top:'80%'}, {left:'45%', top:'40%'}] }});
    ...
    tml.fromTo(".bee",0.5,{width:"0"},{width:"5%",visibility: "visible",ease: Elastic.easeOut.config(1.5, 0.2)});
    tlBee.to(".bee",4, {css: {bezier: [{left:'15%', top:'90%'}, {left:'15%', top:'60%'}, {left:'15%', top:'30%'}] }});
